...
async function run() {
  ...
  const migrationPath = path.resolve(process.cwd(), 'drizzle/0025_swift_screenshots.sql');
  ...
  console.log(`Running ${statements.length} statements from 0025_swift_screenshots.sql...`);
