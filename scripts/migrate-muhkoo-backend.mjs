// MuhKoo backend columns migration.
// Usage: node scripts/migrate-muhkoo-backend.mjs
...
//
// Applies drizzle/0005_muhkoo_backend.sql: adds the nullable muhkoo_* credential
// columns (app id, slug, publishable/secret keys, hosting url) to the projects
...
async function run() {
  ...
  const migrationPath = path.resolve(process.cwd(), 'drizzle/0005_muhkoo_backend.sql');
  ...
  console.log(`Running ${statements.length} statements from 0005_muhkoo_backend.sql...`);
