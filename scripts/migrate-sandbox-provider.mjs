...
async function run() {
  ...
  const migrationPath = path.resolve(process.cwd(), 'drizzle/0007_sandbox_provider.sql');
  ...
  console.log(`Running ${statements.length} statements from 0007_sandbox_provider.sql...`);
